...
import 'package:laundry_scout/screens/home/User/order_preview.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if ((widget.order['items'] as Map<String, dynamic>).containsKey('Drop Off') && widget.order['dropoff_time'] != null)
                      _buildDetailRow(
                        'Drop Off Time',
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => OrderConfirmationScreen(
                            ...
                            phoneNumber: widget.order['mobile_number'],
                            schedule: widget.order['schedule'] ?? {},
                            orderId: widget.order['order_number'],
                          ),
                        ),
                      );
                    },
